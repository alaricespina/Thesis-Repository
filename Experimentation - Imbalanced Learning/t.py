...
def tf_dbn_example():
    ...
    rf.fit(X_train_transformed, y_train_resampled) # Train the RF from DBN values.
    y_pred = rf.predict(X_test_transformed)

    # Display the report, confusion matrix, plot for the DBN + RF models
    print("\nTensorFlow DBN with Random Forest")
    ...
    plt.title("Confusion Matrix - TensorFlow DBN + RF")

...
def tf_dbn_example():
    ...
    # 3. Random Forest - (using the DBN as feature extractor)
    ...
    # Train the model
    model.fit(X_train_transformed, y_train_resampled, epochs=50, batch_size=32, validation_split=0.1) #Added epochs, sizes
